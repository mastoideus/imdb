...
const MoviePageRating = ({ title, popularity, imdbRating, rating }) => {
  return (
    <div className=" text-[12.5px] tracking-widest font-[550] text-gray-400">
      {title}
        ...
        {popularity ? (
          <>
            <svg
              ...
              height="30"
              color="green"
              class="ipc-icon ipc-icon--popularity-up sc-edc76a2-3 ktIVqq"
              id="iconContext-popularity-up"
              viewBox="0 0 24 24"
              fill="currentColor"
              role="presentation"
            >
            ...
            <p className=" font-bold text-xl text-white">{popularity}</p>
          </>
        ) : (
          <>
            {imdbRating ? (
              ...
              <AiOutlineStar className=" text-3xl text-blue-600" />
            )}
